        ...
        <div class="col-lg-7 mb-4">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-success">Posting Lowongan Kerja</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('action-table.store') }}" method="post" enctype="multipart/form-data">

                    @csrf
                    
                    <div class="form-group mt-1">
                        <label for="Lokasi" class="font-weight-bold">Lokasi</label>
                        <input type="text" class="form-control" name="lokasi" placeholder="Lokasi Pekerjaan" id="lokasi" required>
                    </div>
                    ...
                    <div class="form-group mt-3">
                        <label for="kerja" class="font-weight-bold">Kerja Sebagai</label>
                        <input type="text" class="form-control" name="kerja_sebagai" placeholder="ex : Desainer" id="kerja" required>
                    </div>
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input type="text" class="form-control" name="nama_perusahaan" placeholder="required" id="perusahaan" required>
                    </div>
            
                    <div class="form-group mt-3">
                        <label for="link" class="font-weight-bold">Masukkan Link Website</label>
                        <input type="text" class="form-control" name="link" placeholder="required" id="link" required>
                    </div>
