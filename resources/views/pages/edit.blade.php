...
@section('content')
            <div class="jumbotron jumbotron-fluid kotak-atas">
                <div class="container">
                    <div class="row">
                    <div class="col-lg-8 offset-lg-2 col-12 text-center mt-5">
                ...
                <div class="col-lg-7">
                    ...
                    <div class="col-lg-12">
                            ...
                            @foreach ($siswa as $siswa)
                                        <form action="{{ action('ResumeController@update', $siswa->id) }}" method="post" enctype="multipart/form-data">
