...
<body>
    ...
    <div class="jumbotron kotak-atas">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-12 mt-5   ">
                    <nav aria-label="breadcrumb" >
                        <ol class="breadcrumb bg-transparent">
                        <li class="breadcrumb-item" style="color:#36CFCF;">Beranda</li>
                        <li class="breadcrumb-item" style="color:#36CFCF;">Buat Resume</li>
                        <li class="breadcrumb-item ">Tinjau Resume</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container justify-content-center" style="margin-top: 15vh;">
        ...
        <section class="sec1">
            ...
            <form method="post">
                <div class="d-flex">
                    <a href="{{ url('/cetak_pdf', $siswa->id) }}" class="btn btn-light font-weight-normal text-uppercase mb-5 mt-5 mr-2 py-3 px-4 mr-auto" target="_blank">
                        <i class="fas fa-file-pdf mr-1"></i>CETAK PDF
                    </a>
                    <a href="{{ action('ResumeController@edit', $siswa->id) }}" class="btn btn-outline-success font-weight-normal text-uppercase mb-5 mt-5 mr-2 py-3 px-4" type="submit">
                        Edit Resume
                    </a>
                    <button class="btn btn-success font-weight-normal text-uppercase mb-5 mt-5" type="button" data-toggle="modal" data-target="#exampleModal">
                        Kirim Resume
                    </button>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                Resume yang sudah anda buat akan dikirim pada halaman perusahaan, jika anda ingin merubahnya silahkan cek email anda untuk meninjau ulang resume dan download data pdf.
                </div>
